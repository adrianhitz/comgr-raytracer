        ...
        public class Lab06 {
            public static PathtracingScene Scene(Scene.AccelerationStructure accelerationStructure = Raytracing.Scene.AccelerationStructure.None) {
                ...
                var cornellBoxSpheres = new List<ISceneObject> {
                    new Sphere(new Vector3(1001, 0, 0), 1000, new Material(Colour.Red, Colour.Black)),
                    new Sphere(new Vector3(-1001, 0, 0), 1000, new Material(Colour.Blue, Colour.Black)),
                    ...
                    new Sphere(new Vector3(0, -10.99f, 0), 10, new Material(Colour.Black, Colour.Black, Colour.White))
                };
